      ...
      {#if $user}
        <Island>
          <div class="anuka-stack anuka-center" style="min-width: 240px;" role="dialog" aria-modal="true">
            ...
            <button type="button" class="anuka-btn anuka-btn-outline" onclick={() => { signOut(); showAuthDropdown = false }}>
              Sign out
            </button>
          </div>
        </Island>
      {:else}
        <Island>
          <div class="anuka-stack anuka-center" style="min-width: 240px;" role="dialog" aria-modal="true">
            ...
            <button type="button" class="anuka-btn anuka-btn-outline" onclick={() => { signInWithGoogle(); showAuthDropdown = false }}>
            ...
            {:else}
              <form class="anuka-stack anuka-compact" onsubmit={(e) => {
                ...
                <button type="submit" class="anuka-btn anuka-btn-outline">Send Sign In Link</button>
              </form>
            {/if}
          </div>
        </Island>
