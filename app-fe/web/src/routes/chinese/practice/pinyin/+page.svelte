<script>
  ...
  import PracticePinyin from '@uic/kind/chinese/practice-pinyin.svelte'
  ...
  $effect(() => {
    if (sttDataset.id) loadDatasetGroupSessions(sttDataset.id, 'pinyin')
  })
...
<svelte:head>
  <title>Pinyin Practice - Anuka Uchika</title>
</svelte:head>

<main class="anuka-page">
  {#if practiceGroup}
    <PracticePinyin group={practiceGroup} datasetId={sttDataset.id} {backUrl}
