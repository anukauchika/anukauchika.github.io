...
SEO files (`sitemap.xml`, `robots.txt`, `llms.txt`) are regenerated by the
GitHub Pages workflow before deploy. Run `npm run gen:seo` locally only when you
want to review the generated files before pushing.
