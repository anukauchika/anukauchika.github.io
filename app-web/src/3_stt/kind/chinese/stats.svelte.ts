...
import { calcDatasetStats, calcAvgDailyTime, countDrilled, calcProgress, calcMastery, countDueGroups } from '@std/kind/chinese/stats'
...
class StatsState {
  ...
  readonly dueCount = $derived(countDueGroups(this.groups, this.groupProgressStroke, this.groupProgressPinyin))
