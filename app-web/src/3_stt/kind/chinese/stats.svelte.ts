...
import { calcDatasetStats, calcAvgDailyTime, countDrilled, calcProgress, calcMastery, countOverdueGroups } from '@std/kind/chinese/stats'
...
class StatsState {
  ...
  readonly overdueCount = $derived(countOverdueGroups(this.groups, this.groupProgressStroke, this.groupProgressPinyin, this.wordProgressStroke, this.wordProgressPinyin))
